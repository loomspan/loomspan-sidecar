...
RELEASED_FRAMEWORK = "1.0.0-beta.4"
...
def main():
    ...
    if "<loomspan.version>1.0.0-beta.4-SNAPSHOT</loomspan.version>" not in pom and \
            "<loomspan.version>1.0.0-beta.4</loomspan.version>" not in pom:
        raise SystemExit("pom.xml does not use the beta 4 framework line")
