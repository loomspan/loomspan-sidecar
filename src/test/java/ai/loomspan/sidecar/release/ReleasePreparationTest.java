...
class ReleasePreparationTest {
    ...
    void releasePreparationRejectsSnapshotsAndProducesExpectedArtifactPlan() throws Exception {
        ...
        assertThat(script).contains("SNAPSHOT", "1.0.0-beta.4", ".sha256", "zipfile.ZipFile");
        ...
        assertThat(run("1.0.0-beta.4", "1.0.0-beta.4", "v1.0.0-beta.4")).isZero();
        assertThat(run("1.0.0-beta.4-SNAPSHOT", "1.0.0-beta.4", "v1.0.0-beta.4-SNAPSHOT")).isNotZero();
        assertThat(run("1.0.0-beta.4", "1.0.0-beta.3", "v1.0.0-beta.4")).isNotZero();
        assertThat(run("1.0.0-beta.4", "1.0.0-beta.4", "vwrong")).isNotZero();
    }
